                        ...
                        <div className="card-header pb-0">
                            <div className="row">
                                ...
                                <div className="col-md-6 d-flex justify-content-end">
                                    <button type="button" onClick={addDialogHandler} className="btn bg-dark btn-block mb-3 text-success" data-bs-toggle="modal" data-bs-target="#exampleModalMessage">
                                ...
                                <table className="table align-items-center justify-content-center mb-0" width="100%">
                                    <thead>
                                        <tr>
                                            ...
                                            { auth.user.rent != 0 ? <p></p>:                                            <th className="text-uppercase text-secondary text-xxs font-weight-bolder text-center opacity-7 ps-2">Actions</th>
}
                                        </tr>
                                    </thead>
                                    <tbody>
                                        {complains.map((complain) => (
                                            <tr key={complain.id}>
                                                ...
                                                <td className="align-middle " width="10%">
                                                    { complain.isComplete ? <i class="fas fa-check-circle text-success"></i> : <i class="fas fa-exclamation-circle text-danger"></i>}
                                                </td>
                                                {auth.user.rent != 0 ? <p></p> :
                                                    <td className="align-middle text-center" width="10%">
                                                        <div>
                                                            <button type="button" onClick={() => openDestroyDialog(complain)} className="btn  btn-icon-only">
